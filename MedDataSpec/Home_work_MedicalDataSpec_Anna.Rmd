...
*Комментарий: Информативность уровня гемоглобина для предсказания летального исхода явялется умеренной: площадь под ROC-кривой составляет 0.701, 95% ДИ: 0.669-0.732.*
