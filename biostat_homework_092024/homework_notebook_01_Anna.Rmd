...
cleaned_data |> 
  ...
  #geom_beeswarm(aes(x=cardio, y=value))+
...
```
Для визуализации пропорций подходят отнормированные столбики, наглядно демонстрирующие доли каждой категории между группами. 
...
cleaned_data |> 
  ...
  cor() |> corrplot(method = 'color', col = COL2('RdBu', 10))
